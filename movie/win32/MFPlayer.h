...
protected:
	...
	HWND		OwnerWindow;
	bool		Visible;
	// Accessed by the Media Foundation work queue as well as the UI thread.
	volatile LONG	Shutdown;
	HANDLE		SessionClosedEvent;
	HANDLE		CallbackIdleEvent;
...
public:
	...
	bool IsShuttingDown() { return InterlockedCompareExchange(&Shutdown, 0, 0) != 0; }
	void OnMediaSessionClosed();
	void EnterCallback();
	void LeaveCallback();
