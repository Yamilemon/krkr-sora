...
typedef void (*tTVPGraphicHeaderLoadingHandler)(void* formatdata,  iTJSBinaryStream *src, class iTJSDispatch2** dic );
typedef void (*tTVPGraphicSaveHandler)(void* formatdata,  iTJSBinaryStream* dst, const class tTVPBaseBitmap* image,
...
struct tTVPGraphicHandlerType
{
	...
	void Header( iTJSBinaryStream *src, iTJSDispatch2** dic );
