...
//---- デバッグ支援
	...
	virtual void TJS_INTF_METHOD UpdateVideo(int w, int h, std::function<void(char *dest, int pitch)> updator) = 0;
	...
	virtual void TJS_INTF_METHOD ClearVideo() = 0;
	...
	virtual void TJS_INTF_METHOD SetWaitVSync(bool enable) = 0;
#endif
